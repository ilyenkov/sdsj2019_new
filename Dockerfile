...
RUN pip3 install numpy==1.17.2 scipy sklearn pandas==0.24.2 nltk==3.2.5 gensim==3.8.0 torch lightgbm 
RUN pip3 install catboost pytorch_pretrained_bert==0.6.2 matplotlib==3.0.3 python-Levenshtein 
RUN pip3 install sklearn_crfsuite fastai fuzzywuzzy keras tqdm pymorphy2 summa pymystem3 pymorphy2 
RUN pip3 install pymorphy2-dicts-ru jellyfish flask requests tensorflow
